...
<head>
    ...
    <link rel="stylesheet" href="css/repointdonhang.css">
<%--    <link rel="stylesheet" type="text/css" href="Vender/DataTables/datatables.min.css"/>--%>
<%--    <link rel="stylesheet" type="text/css" href="test/DataTables/datatables.min.css"/>--%>
...
<%--    <link href="Vender/MDB-Free_4.20.0/css/bootstrap.min.css" rel="stylesheet">--%>
<%--    <link rel="stylesheet" href="Vender/MDB-Free_4.20.0/css/mdb.min.css">--%>
<%--    <link rel="stylesheet" href="Vender/MDB-Free_4.20.0/css/admin.css">--%>
</head>
<body>
<div  >
<%--    <table id="cartI" >--%>
...
<%--            <td>--%>
<%--                <div>${product.totalMoney}</div>--%>
<%--            </td>--%>
<%--            <td>--%>
<%--                <button   style="border-radius: 5px;">Xóa</button>--%>
<%--            </td>--%>
<%--        </tr>--%>
...
<div class="header boxcenter">
        ...
        <div class="header--contact__">
            <a href="">
                <div class="header--contact__about" >
                    ...
                    <a href="dangnhap.html" class="header--contact__span" style="position: relative; top:5px;"> My Account</a>
                </div>
            </a>
            <a href="">
    ...
    <div class="row mb " style="max-width: 1380px;margin: auto;margin-left: 160px;margin-top: 5px; background-image: linear-gradient( #cccc,#1d1c1c);">
        <div class="boxtrai mr ste" style=" background-image: linear-gradient( rgba(43, 41, 41, 0.8),#1d1c1c);height: 1100px;border-radius: 6px; ">
            <div class="row" >
                <h1 style="font-size: 20px;color: #abad0a;margin:20px ;">THÔNG TIN Đơn hàng</h1>
                ...
                <table id="cart" class="table table-striped table-bordered" style="width:100%">
                    ...
                    <c:forEach items="${products}" var="product">
                        <tr>
                            ...
                            <td>${product.price}</td>
                            <td>${product.quantitySol}</td>
                            <td><div>${product.totalMoney}</div></td>
                            <td><button   style="border-radius: 5px;">Xóa</button></td>
