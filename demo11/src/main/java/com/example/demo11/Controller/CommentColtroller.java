...
public class CommentColtroller extends HttpServlet {
    @Override
...
if(request.getCharacterEncoding()!=null){
    request.setCharacterEncoding("UTF-8");
        ...
        RequestCommentSevlet.getInstance().InsertRequestComment("1",content,username);
        ...
        CommentService.getInstance().InsertComment(content,id,username);
